...
library LHelper {
    IWETH constant internal weth = IWETH(address(0x094616F0BdFB0b526bD735Bf66Eca0Ad254ca81F));
...
contract Random is VRFConsumerBase, IRandom, RandomFee {
        ...
        )
    {
        ...
        _randomRequester = IRandomRequester(0xCb10161c8dbbd392E5f622105426865F186f4367);
    }
